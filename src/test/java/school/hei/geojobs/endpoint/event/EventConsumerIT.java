package school.hei.geojobs.endpoint.event;
...
import school.hei.geojobs.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "school.hei.geojobs.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
