package school.hei.geojobs.unit;
...
import school.hei.geojobs.endpoint.event.EventConsumer;
import school.hei.geojobs.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("school.hei.geojobs.endpoint.event.gen.UuidCreated", payload);
