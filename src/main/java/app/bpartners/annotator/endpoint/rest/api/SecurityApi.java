...
import app.bpartners.annotator.endpoint.rest.model.DummyComponent;
import app.bpartners.annotator.endpoint.rest.model.InternalServerException;
import app.bpartners.annotator.endpoint.rest.model.Whoami;
  ...
  public ApiResponse<DummyComponent> checkDbHealthWithHttpInfo() throws ApiException {
    ...
    try {
      ...
      return new ApiResponse<DummyComponent>(
          ...
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<DummyComponent>() {})
        );
    } catch (IOException e) {
