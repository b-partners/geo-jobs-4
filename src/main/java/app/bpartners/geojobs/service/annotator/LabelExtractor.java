...
@Component
public class LabelExtractor implements Function<DetectableObjectType.DetectableType, Label> {
  @Override
  public Label apply(DetectableObjectType.DetectableType detectableType) {
    return new Label()
  ...
  private static String getColorFromDetectedType(
      DetectableObjectType.DetectableType detectableType) {
