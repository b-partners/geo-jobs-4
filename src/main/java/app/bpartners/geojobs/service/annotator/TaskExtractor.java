...
public class TaskExtractor
  ...
  private CreateAnnotatedTask extractTask(DetectedTile detectedTile, String annotatorId) {
    String taskId = randomUUID().toString();
    return new CreateAnnotatedTask()
        .id(taskId)
        .annotatorId(annotatorId)
        .filename(detectedTile.getBucketPath())
        .annotationBatch(createAnnotationBatchExtractor.apply(detectedTile, annotatorId, taskId));
  }
