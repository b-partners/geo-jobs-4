...
@Component
@AllArgsConstructor
public class StatusMapper<T extends school.hei.geotiler.repository.model.Status> {

  public static Status.ProgressionEnum toProgressionEnum(
      school.hei.geotiler.repository.model.Status.ProgressionStatus domain) {
  ...
  public static Status.HealthEnum toHealthStatus(
      school.hei.geotiler.repository.model.Status.HealthStatus domain) {
    return switch (domain) {
